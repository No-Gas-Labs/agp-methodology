        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-6">
              <a href="#audio" className="primary inline-block">
                ▶ Listen
              </a>
              <a href="/pdf/agp-methodology-v1.pdf" className="inline-block border border-cyan-500 text-cyan-500 px-6 py-3 rounded hover:bg-cyan-500/10 transition-colors">
                ⬇ Download PDF
              </a>
            </div>
          </div>
          ...
          <div className="bg-slate-900 p-8 border border-slate-800 rounded">
            ...
            <div className="border-t border-slate-800 pt-6">
              <p className="text-slate-400 text-sm">
                <strong className="text-slate-200">Audio Duration:</strong> ~45 minutes<br />
                <strong className="text-slate-200">Format:</strong> WAV, High Quality<br />
                <strong className="text-slate-200">SHA256:</strong> <code className="text-xs">f379f1dee6e6edd98236407b77fa9d9b124405ef6dc5136d29df0470c8a24cf0</code>
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="archive" className="py-24">
        <div className="max-w-4xl mx-auto px-4 space-y-8">
          ...
          <div className="metadata-section space-y-4">
            ...
            <div>
              <strong className="text-cyan-400">Repository:</strong> <a href="https://github.com/No-Gas-Labs/agp-methodology" className="text-cyan-400 hover:text-cyan-300">github.com/No-Gas-Labs/agp-methodology</a>
            </div>
            <div>
              <strong className="text-cyan-400">License:</strong> MIT
            </div>
            <div>
              <strong className="text-cyan-400">Audio Hash (SHA256):</strong> <code className="text-xs">f379f1dee6e6edd98236407b77fa9d9b124405ef6dc5136d29df0470c8a24cf0</code>
            </div>
            <div>
              <strong className="text-cyan-400">Commit Hash:</strong> <code className="text-xs">4265ff9</code>
            </div>
            <div>
              <strong className="text-cyan-400">Wayback Archive:</strong> <a href="https://web.archive.org/web/*/agp-methodology.vercel.app" className="text-cyan-400 hover:text-cyan-300">archive.org/web/</a> (after deployment)
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-slate-900 border border-slate-800">
              ...
              <a href="https://github.com/No-Gas-Labs/agp-methodology" className="text-cyan-400 hover:text-cyan-300 font-semibold">View Repository →</a>
            </div>
            ...
            <div className="p-6 bg-slate-900 border border-slate-800">
              ...
              <a href="https://web.archive.org/web/*/agp-methodology.vercel.app" className="text-cyan-400 hover:text-cyan-300 font-semibold">View Archive →</a>
            </div>

            <div className="p-6 bg-slate-900 border border-slate-800">
              <h4 className="text-cyan-400 mb-3">Audio File</h4>
              <p className="text-sm text-slate-400 mb-4">High-quality presentation audio.</p>
              <a href="https://d2xsxph8kpxj0f.cloudfront.net/310519663290410840/HyGdzmg3GE9L4M3aWYLZ3Y/hybrid_cognition_presentation_052bdfcf.wav" className="text-cyan-400 hover:text-cyan-300 font-semibold">
                Download Audio →
              </a>
            </div>

            <div className="p-6 bg-slate-900 border border-slate-800">
              <h4 className="text-cyan-400 mb-3">Source Code</h4>
              <p className="text-sm text-slate-400 mb-4">Complete Next.js project with all files.</p>
              <a href="https://github.com/No-Gas-Labs/agp-methodology/archive/refs/heads/main.zip" className="text-cyan-400 hover:text-cyan-300 font-semibold">
                Download ZIP →
              </a>
            </div>
          </div>
      ...
      <footer className="py-12 bg-slate-900 border-t border-slate-800">
        <div className="max-w-4xl mx-auto px-4 space-y-8">
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500">
            <p>Version 1.0 | Build: 2026-03-27</p>
            <div className="flex gap-6 mt-4 md:mt-0">
              <a href="https://github.com/No-Gas-Labs/agp-methodology" className="hover:text-cyan-400 transition-colors">GitHub</a>
              <a href="https://github.com/No-Gas-Labs/agp-methodology/blob/main/LICENSE" className="hover:text-cyan-400 transition-colors">License</a>
              <a href="mailto:damien@agp.systems" className="hover:text-cyan-400 transition-colors">Contact</a>
            </div>
          </div>
        </div>
      </footer>
